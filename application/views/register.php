...
<head>
  ...
  <title>Form Register Customer</title>
    ...
    <section class="content" style="width: 800px; margin: 100px auto;">
      <div class="container">
         ...
         <div class="row">
          ...
          <div class="col-md-12">
                <div class="card-body">
                  <h4 align="center">Form Register Customer</h4>
                ...
                <div class="input-group mb-2">
                  <input type="text" class="form-control" name="password2" placeholder="Ulangi password...">
                  <div class="input-group-append">
                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                  </div>
                </div>
